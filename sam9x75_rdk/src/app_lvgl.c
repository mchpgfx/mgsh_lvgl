...
__attribute__ ((section(".region_nocache"), aligned (32))) uint16_t buff[720 * 720];
#else
__attribute__ ((aligned (32))) uint16_t buff[720 * 720];
#endif
...
static void lv_disp_drv_flush_cb(lv_display_t * disp_drv, const lv_area_t * area, uint8_t * color_p) 
{
    ...
    screen_surface.width = 720;
    screen_surface.height = 720;
